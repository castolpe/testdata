...
merge 1:1 ahhnr using out/ahgen.dta, nogenerate
gen  hdist = . 
...
use out/bhgen.dta, clear
merge 1:1 bhhnr using out/bhgen.dta, nogenerate
gen  hdist = . 
...
use out/chgen.dta, clear
merge 1:1 chhnr using out/chgen.dta, nogenerate
gen  hdist = . 
